...
def get_qiugou_info(myUrl):
    ...
    if html != '':
        ...
        addrs = u'山东'.encode('utf-8')+title.split('-')[0]
        if telephone != '':
            ...
            try:
                ...
                if not getrows:
                    ...
                    res = [title,vehicle_info,name,telephone,addrs,release_time,prices,is_seller,owner_readme,info_src,myUrl]
...
#get_qiugou_info('http://2sc.sohu.com/js-nj/buycar/carinfo_sohuperson_1370851.shtml#args=a0b0c0d0e0f0g1h0j0k0m0n0p0q0r320000s0t1')

#print "=================================================================================="

#get_qiugou_info('http://2sc.sohu.com/js-nj/buycar/carinfo_sohuperson_1374918.shtml#args=a0b0c0d0e0f0g1h0j0k0m0n0p0q0r320000s0t1')

#print "=================================================================================="

#get_qiugou_info('http://2sc.sohu.com/js-suzhou/buycar/carinfo_sohu_363636.shtml#args=a0b0c0d0e0f0g2h0j0k0m0n0p0q0r320000s0t1')


#print "=================================================================================="

#get_qiugou_info('http://2sc.sohu.com/js-suzhou/buycar/carinfo_sohu_1340889.shtml#args=a0b0c0d0e0f0g2h0j0k0m0n0p0q0r320000s0t1')

#print "=================================================================================="

#get_qiugou_info('http://2sc.sohu.com/js-suzhou/buycar/carinfo_sohu_1343226.shtml#args=a0b0c0d0e0f0g3h0j0k0m0n0p0q0r320000s0t1')
...
def main():
    url="http://2sc.sohu.com/sd/buycar/a0b0c0d0e0f0g2h0j0k0m0n0/pg"
    localfile="Href.txt"
    for i in range(1,5):

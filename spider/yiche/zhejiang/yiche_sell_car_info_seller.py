...
#get_qiugou_info('http://www.taoche.com/buycar/b-Dealer15021110471.html')
#get_qiugou_info('http://www.taoche.com/buycar/b-Dealer15011410446.html')
def main():
    url="http://zhejiang.taoche.com/buycar/pges2bxcdza/?page="
    localfile="Href.txt"
    for i in range(1,5):
        myUrl = url + str(i)

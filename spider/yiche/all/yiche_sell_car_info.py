    ...
    #print seller_readme
        ...
        try:
            ...
            if img_src != '':
                ...
                if not getrows:
                    curs.execute("select id from yiche_sell_car_info where telephone_num = '%s'" % telephone_num)
...
def main():
    url_list = ["http://jiangsu.taoche.com/buycar/pges1bxcdza/?page=","http://shandong.taoche.com/buycar/pges1bxcdza/?page=","http://anhui.taoche.com/buycar/pges1bxcdza/?page=","http://zhejiang.taoche.com/buycar/pges1bxcdza/?page=","http://shanghai.taoche.com/buycar/pges1bxcdza/?page="]
    for url in url_list:
        localfile="Href.txt"
        address = ''

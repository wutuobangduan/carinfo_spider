    ...
    if html != '':
        ...
        if len(title.split('['))>1:
            if len(title.split('[')[1].split(']'))>0:
                if u'南京'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'无锡'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'苏州'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'常州'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'徐州'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'连云港'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'淮安'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'南通'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'盐城'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'镇江'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'扬州'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'泰州'.encode('utf-8') in title.split('[')[1].split(']')[0] or u'宿迁'.encode('utf-8') in title.split('[')[1].split(']')[0]:
                    addrs = u"江苏".encode('utf-8') + title.split('[')[1].split(']')[0]
...
def main():
    ...
    for i in range(1,5):
        ...
        myUrl = url + str(i) + "&sr=null&prov=%BD%AD%CB%D5"

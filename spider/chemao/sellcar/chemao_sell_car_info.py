                    ...
                    for div4 in div3.find_all('div',attrs={'class':'item'}):
                        for em in div4.find_all('em'):
                            if m == 1:
                                ...
                                addrs += u"江苏".encode('utf-8') + str(em.get_text())
                            elif m == 4:
...
def main():
    url="http://www.chemao.com.cn/market-condition-zZUKP4h7EsHQxisn8vxYD7h-RnF9qNdFdc9XUwyuL2Y.-page-"
    localfile="Href.txt"
    for i in range(1,6):
